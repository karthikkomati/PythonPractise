...
def create(firstname,lastname,username,password,email):
    ...
    #q = "insert into users(Firstname,Lastname,Username,Password,Email) values('{}','{}','{}','{}','{}')".format(firstname,lastname,username,password,email)
...
#create("test3","test3","test3","test3","test3")
#read("username","test2")
#deleteUser("test3")
#delete("firstname","test3")
#updateAll("update","update1","update","update","update","update",)
#update("update","password","pass")
#readAll()
